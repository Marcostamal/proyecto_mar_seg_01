...
async def get_count_platform(platform: str):
    ...
    >>> {"Cantidad": 9668}
    """
    db = pd.read_csv("https://raw.githubusercontent.com/Marcostamal/PI_MASA_DE/main/Data_util/Plataformas_score.csv") # Cargo la data
...
async def get_score_count(platform:str, scored:float, year:int):
    ...
    """
    db = pd.read_csv("https://raw.githubusercontent.com/Marcostamal/PI_MASA_DE/main/Data_util/Plataformas_score.csv")
